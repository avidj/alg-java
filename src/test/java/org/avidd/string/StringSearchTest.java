...
public abstract class StringSearchTest {
  ...
  public void testNeedleInAHaystack() {
    ...
    Assert.assertThat(pos, is(equalTo(8)));
  }
  ...
  public void testPrefix() {
    ...
    final int pos = stringSearch().search(pattern, text);
    Assert.assertThat(pos, is(equalTo(0)));
  }
  ...
  public void testSuffix() {
    ...
    final int pos = stringSearch().search(pattern, text);
    Assert.assertThat(pos, is(equalTo(text.length() - pattern.length())));
  }
  ...
  public void testLongTextLate() {
    ...
    Assert.assertThat(pos, is(equalTo(964)));
  }
}
